...
const Testimonials = () => {
  ...
  const { data: testimonials = [], isLoading } = useQuery({
    queryKey: ["website-reviews"],
    queryFn: async () => {
      const res = await axiosInstance.get("/reviews/website-reviews");
      return res.data.data;
    },
  });
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-14">
          ...
          <p className="mt-3 text-slate-500 max-w-2xl mx-auto">
            Real feedback from our marketplace community.
          </p>
        ...
        <div className="overflow-hidden" ref={emblaRef}>
          <div className="flex">
            ...
            {testimonials.map((review: WebsiteReview) => (
              <div
                key={review._id}
                className="min-w-[340px] md:min-w-[380px] px-4"
              >
                <div className="h-full rounded-3xl bg-white border border-slate-200 p-8 shadow-md hover:shadow-xl transition-all">
                  ...
                  <p className="text-slate-600 italic leading-8">
                    "{review.comment}"
                  </p>
